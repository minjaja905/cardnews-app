...
4. 마케터 팁 (Marketer Tip) — 이 밈을 브랜드/마케터가 활용할 수 있는 방법 3가지
  ...
  "variations": [
    {
      ...
      "card3": {
        "heroLines": [{"text": "...", "color": "#1A1A1A"}, {"text": "...", "color": "#3ECFB2"}],
        "subtitleLines": ["확산 맥락 설명 1줄", "2줄 (인용 or 에피소드)", "3줄"],
        "mintBoxLines": ["인사이트 박스1 (이 밈이 퍼진 이유 한 줄)", "인사이트 박스2 (특징적인 패턴)", "큰 마무리 teal 텍스트 (밈 문구 활용, 20자 이내)"]
      },
      "card4": {
        "heroLines": [{"text": "마케터가 이 밈을", "color": "#1A1A1A"}, {"text": "주목해야 할 이유", "color": "#3ECFB2"}],
        "descText": "이 밈이 브랜드 마케팅에 유용한 이유 한 줄 (30자 이내)",
        "reasonLines": ["구체적인 활용법 또는 주목 이유 1 (업계·방법·타이밍, 30자 이내)", "이유 2", "이유 3"],
        "insightText": "핵심 액션 인사이트 (예: '밈 발화 후 2주 이내 콘텐츠 발행이 핵심', 30자 이내, teal 강조)"
      },
      "card5": {
      ...
      "card6": {
        "heroText": "밈 이름",
        "subText": "이 밈의 핵심 감성을 살린 위트있는 한 줄 — generic 금지. 밈 특유의 뉘앙스를 담아 이모지 포함 20자 이내로 (예: '나 이미 받았다.. 😇' / '오늘 몇 번 red red였나요? 🫧' / '최애를 표현하는 새로운 표현 💚')",
  ...
  "variations": [
    {
      ...
      "card2": {
        ...
        "badgeLabel": "카테고리 태그 (예: 영화 밈, 드라마, 트렌드, SNS밈 — 8자 이내)"
      },
